...
class SiteController extends Controller
{
    ...
    public function actionPsubscribe()
    {
        ...
        $sub = $redis->executeCommand('PSUBSCRIBE',['redisChat']);
        var_dump($sub);
    }
    ...
    public function actionPublish()
    {
        ...
        // $pub = $redis->publish('redisChat','hello!');
        $pub = $redis->executeCommand('PUBLISH',['redisChat','hello!']);
        var_dump($pub);
    }

    public function actionLpush($value='')
    {
        $redis = Yii::$app->redis;

        $lpsh = $redis->executeCommand('LPUSH',['redisList','a','b','c']);
        var_dump($lpsh);
    }

    public function actionLrange($value='')
    {
        $redis = Yii::$app->redis;

        $lrng = $redis->executeCommand('LRANGE',['redisList',0,10]);
        var_dump($lrng);
    }

    public function actionGetFirstCharter($string='杭州')
    {
        $stringList = array();
